...
mlflow.set_experiment("xgb-reg-hyperopt-oob-experiment-set_random-state-2")
mlflow.set_experiment("xgb-check-it-2")
...
def run_optimization(data_path: str, num_trials: int):
    ...
    def objective(trial):
        ...
        'n_estimators': 100,
        'random_state': 42
        #'random_state': trial.suggest_int('random_state', 1, 32)
    }
...
if __name__ == '__main__':
    ...
    # def objective(trial):
    # params = {
    #     'eta': trial.suggest_float('eta', 0.1, 0.3, 0.01),
    #     'max_depth': trial.suggest_int('max_depth', 1, 10),
